...
### Ключевая находка
**Location match → +49% к конверсии** — самый важный признак
...
### Inference (без переобучения)
1. Убедитесь, что есть файлы: `catboost_ranker.cbm`, `model_metadata.pkl`, `test_features_processed.parquet`
2. Запустите секцию 15 в ноутбуке
